...
public class CustomerControllerDeleteTest {
    ...
    @Test
    public void givenCustomers_whenDeleteCustomer_byId_27_thenStatus200() throws Exception {
        ...
        mvc.perform(get("/api/customers")
                ...
                .andExpect(content().json(getCustomersBeforePost()));
        ...
        mvc.perform(get("/api/customers")
                ...
                .andExpect(content()
                        .contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(content().json(getCustomersAfterPost()));
    ...
    private String getCustomersBeforePost() {
        return "[\n" +
                "  {\n" +
                "    \"id\": 1,\n" +
    ...
    private String getCustomersAfterPost() {
        return "[\n" +
                "  {\n" +
                "    \"id\": 1,\n" +
                "    \"organizationName\": \"Tesco\",\n" +
